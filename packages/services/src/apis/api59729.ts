...
/**
 * 查询欢迎语模板详情
 * https://yapi.yza.cn/project/272/interface/api/59729
 **/
...
export const currentUrl = getCurrentUrl(272, '/qywx/welcomeTemplate/detail')

export default (
    data?: IReqapi59729,
    extendConfig?: ExtendConfig
): Promise<IResapi59729['data']> =>
    service({
        method: 'POST',
        url: currentUrl,
        data: data,
