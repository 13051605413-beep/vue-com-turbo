...
/**
 * 新增AI群组配置
 * https://yapi.yza.cn/project/272/interface/api/60011
 **/
...
export const currentUrl = getCurrentUrl(272, '/qywx/ai/groupConfig/add')

export default (
    data?: IReqapi60011,
    extendConfig?: ExtendConfig
): Promise<IResapi60011['data']> =>
    service({
        method: 'POST',
        url: currentUrl,
        data: data,
